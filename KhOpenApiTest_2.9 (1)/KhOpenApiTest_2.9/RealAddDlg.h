...
protected:
	...
	afx_msg void OnBnRealRemove();
	afx_msg HCURSOR OnQueryDragIcon();
	afx_msg void OnBnRealReg();
	afx_msg void OnBtnClose();
	afx_msg void OnBnRealRemoveAll();
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnConditionLoad();
	afx_msg void OnBnSearchReal();
	afx_msg void OnBnSearchRealStop();
	afx_msg void OnBnConditionSearch();
};
