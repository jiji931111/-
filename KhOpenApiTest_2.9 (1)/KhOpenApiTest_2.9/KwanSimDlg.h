...
public:
	CWnd*					m_pParent;
	CString					m_strScrNo;
	CMapStringToString		m_mapJongCode;		// 복수종목 저장맵

	CCellID					m_cellSelect;		// 그리드 선택 행
	CGridCtrl				m_grdKwanSim;		// 그리드
	void InitMultiCodeGrid();						// 그리드 초기 처리
	void SetMultiCode();						// 그리드에 종목 설정 처리
	// 종목 조회 요청
